...
var itemCount= 120;
//名单
var nameList = ['林杰','华超','敏玲','林茵','飞燕','维燕','泽嘉','梁权','李权', '婷婷', '萍萍'];
//已抽中名单
// var nameP = ['林杰', '敏玲'];
//跑马灯循环
var tx;
...
$("document").ready(function(){
	...
	if(localStorage.getItem("sequence")){
        ...
        //加入已抽中名单
        // $('.ss ol').append('<li data-number='+itIndex+'>' + '</li>');
		$(".ss").html(ssHtml);
		console.log(ssHtml);
	}
	...
	for(var i=0;i<=itemCount -1;i++){
		$("div.items").append("<div class='item i"+i+"'>"+nameList[i]+"</div>");
    }
	//本地存储item宽度信息
	...
	$("body").keydown(function(e){
		...
		if(e.keyCode==32||e.keyCode==65){
			...
			if(!isRun){
                ...
                //         r=n;
                // }
                $('.ss ol').append('<li data-number='+itIndex+'>'+it+"号："+r+'；</li>');
                // if(r==n){
                //     r='<h3>'+r+'！</h3>';
                // }else{
                //     r='<h2>恭喜您，抽得'+r+'！</h2>';
